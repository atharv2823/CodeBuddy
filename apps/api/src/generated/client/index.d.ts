...
export namespace Prisma {
  ...
  */
    ...
    model: {
      ...
      RoomMember: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.RoomMemberFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.RoomMemberAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type RoomOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "isClosed" | "userId", ExtArgs["result"]["room"]>
  ...
  interface RoomFieldRefs {
    ...
    readonly isClosed: FieldRef<"Room", 'Boolean'>
  ...
  export type RoomMemberOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "roomId" | "userId", ExtArgs["result"]["roomMember"]>
  ...
  export interface RoomMemberDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more RoomMembers that matches the filter.
     * @param {RoomMemberFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const roomMember = await prisma.roomMember.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: RoomMemberFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a RoomMember.
     * @param {RoomMemberAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const roomMember = await prisma.roomMember.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: RoomMemberAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
   ...
   * RoomMember findRaw
   */
  export type RoomMemberFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * RoomMember aggregateRaw
   */
  export type RoomMemberAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type RoomWhereInput = {
    ...
    isClosed?: BoolFilter<"Room"> | boolean
  ...
  export type RoomScalarWhereWithAggregatesInput = {
    ...
    isClosed?: BoolWithAggregatesFilter<"Room"> | boolean
